sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/demo/ui/app", ".html");
		...
		return Opa5.extend("com.sap.demo.ui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/demo/ui/localService/mockserver"], function (mockserver) {
